...
- [x] 진입 조건:
  - 당일 거래량이 전일 거래량 대비 500% 이상 증가
  - 3% 이상 상승
  - EMA 60일선 위
  - 양봉이어야 함 (종가 > 시가)
  - 종가 배팅 (3시 15분에 매수들어간다)
- [x] 매수 제외 조건:
  - 위꼬리가 너무 길 경우(고가 대비 종가가 10%이상 차이)
  - 주가 1000원 이하
  - 주가 30만원 이상
  - 거래량 80만개 이하
  - 상한가
...
- [x] 청산 조건 (우선순위 순서):
  - 3 영업일 안에 청산한다.
  - 매수일 거래량의 50% 이상의 거래량이 나올 때 마다 3 영업일을 연장한다.
  - 매수일 거래량을 넘는 거래량이 나올 경우 3일이 지나지 않아도 청산한다.
  - 조건 충족 시 장 마감 전에 매도 (3시 10분~20분 사이)
